...
INSERT INTO `T_Gast` VALUES (1,'Jaime','Lennister'),(2,'Cersei','Lennister'),(3,'Daenerys','Targaryen'),(4,'Admin','1234'),(5,'roma','fen'),(6,'roma ','fen'),(7,'Max','Muster'),(8,'Dima','Nevydaylo'),(9,'Jurabek','Nurmagomedov'),(10,'test','test'),(11,'max','mustermann'),(12,'123','Nevydaylo'),(13,'Dimadi','dddd'),(14,'43432','grgrgrrg'),(15,'scjscjsjsdj','sjjdsnfenhfce'),(16,'fvmkfnvjfnb','jdcnwjncwjv'),(17,'ffmemfem','dfdnfjdf'),(18,'565656','edfdefe'),(19,'5959595959','fknveofpnvlafkjndvlkanejv'),(20,'brgbrbrb','dcdcd'),(21,'eferfe','rfrrfr'),(22,'Muster','Mister'),(23,'Maxxx','Mustermann'),(24,'546456','gfwgfegweg'),(25,'3457437','35747437');
...
INSERT INTO `T_Musikwunsch` VALUES (1,'Raining Blood','Thrash Metal','Slayer',58),(2,'Nothing Else Matters','Ballade','Metallica',66);
...
INSERT INTO `T_Playlist` VALUES (1,1,'Party-Time'),(2,1,'new playlist'),(3,1,'4444'),(4,1,'ecewcwecw'),(5,1,'TestPlaylist'),(6,1,'sasasasasas'),(7,1,'Dima'),(8,1,'Test'),(9,1,'Test Playlist'),(10,1,'34343434'),(11,1,'Dimas Playlist'),(12,1,'Test3');
...
CREATE TABLE `T_Playlist_Song` (
  ...
  KEY `playlist_song_fk_song` (`song_id`),
  CONSTRAINT `playlist_song_fk_song` FOREIGN KEY (`song_id`) REFERENCES `T_Musikwunsch` (`song_id`) ON DELETE CASCADE,
...
INSERT INTO `T_Playlist_Song` VALUES (1,1,1),(1,2,2);
...
CREATE TABLE `T_Vote` (
  ...
  KEY `t_vote_ibfk_2` (`f_song_id`),
  CONSTRAINT `t_vote_ibfk_1` FOREIGN KEY (`f_gast_id`) REFERENCES `T_Gast` (`gast_id`),
  CONSTRAINT `t_vote_ibfk_2` FOREIGN KEY (`f_song_id`) REFERENCES `T_Musikwunsch` (`song_id`) ON DELETE CASCADE,
  CONSTRAINT `vote_fk_song` FOREIGN KEY (`f_song_id`) REFERENCES `T_Musikwunsch` (`song_id`) ON DELETE CASCADE
...
INSERT INTO `T_Vote` VALUES (1,1,1,'2023-11-24','12:00:00'),(2,2,2,'2023-11-24','12:05:00'),(6,3,1,'2023-11-24','12:25:00'),(7,1,2,'2023-11-24','12:30:00'),(10,1,1,'2023-11-24','12:45:00');
...
-- Dump completed on 2025-02-11 11:29:56
